import AudioToggle from "./AudioToggle";
  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center bg-[url('/bg-luxeevents.png')] bg-cover text-center md:px-8 px-4">
        <h1 className="text-4xl md:text-6xl font-bold mb-4 text-white drop-shadow-lg">Événements haut de gamme</h1>
        <p className="text-lg md:md:text-2xl text-xl text-white/80 mb-6">Le luxe à la portée de tous.</p>
