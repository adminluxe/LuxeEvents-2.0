    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <div className="relative">
        <div
          ...
          style={{
            background:
              "radial-gradient(1200px 600px at 20% 10%, rgba(212,175,55,0.20), transparent 60%), radial-gradient(900px 500px at 80% 20%, rgba(212,175,55,0.12), transparent 55%), radial-gradient(800px 600px at 50% 90%, rgba(255,255,255,0.06), transparent 60%)",
          }}
        />
        <div className="mx-auto w-full max-w-5xl px-4 sm:px-6 lg:px-8 pt-24 pb-16">
          <div className="mb-8">
